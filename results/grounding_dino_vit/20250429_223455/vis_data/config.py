...
coco_od_dataset = dict(
    ...
    pipeline=[
        ...
        dict(
            ...
            tokenizer_name=
            '/home/vault/iwi5/iwi5234h/Dataset/mmdetection/checkpoints/bert-base-uncased',
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        lr=7.142857142857143e-05, type='AdamW', weight_decay=0.0001),
    paramwise_cfg=dict(
        custom_keys=dict(
...
test_dataloader = dict(
    dataset=dict(
        ann_file='test/annotations/test_adjusted.json',
...
test_evaluator = dict(
    ann_file='data/stenosis/test/annotations/test_adjusted.json',
    metric='bbox',
