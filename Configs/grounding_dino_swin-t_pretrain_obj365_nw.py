...
lang_model_name = '/home/vault/iwi5/iwi5234h/Dataset/mmdetection/checkpoints/bert-base-uncased'
...
model = dict(
    ...
    decoder=dict(
        ...
        layer_cfg=dict(
            ...
            self_attn_cfg=dict(embed_dims=256, num_heads=8, dropout=0.1,batch_first=True,cross_attn=False),
            # cross attention layer query to text
            cross_attn_text_cfg=dict(embed_dims=256, num_heads=8, dropout=0.0),
            # cross attention layer query to image
            cross_attn_cfg=dict(embed_dims=256, num_heads=8,dropout=0.1 ,batch_first=True, cross_attn=True),
            ffn_cfg=dict(
                embed_dims=256, feedforward_channels=2048, ffn_drop=0.0)),
        post_norm_cfg=None),
...
# dataset settings
train_pipeline = [
    dict(type='LoadImageFromFile', backend_args=None),      #_base_.backend_args          
